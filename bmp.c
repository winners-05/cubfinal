...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/02/03 14:38:07 by sel-fcht          #+#    #+#             */
/*   Updated: 2021/02/03 18:58:09 by sel-fcht         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		header_init(void)
{
	g_bmp.type[0] = 0x42;
	g_bmp.type[1] = 0x4D;
	g_bmp.filesize = ((int)g_width * (int)g_height * 4) + 54;
	g_bmp.reserved1 = 0x00000000;
	g_bmp.reserved2 = 0x00000000;
	g_bmp.pxdataoff = 0x36;
	g_bmp.headersize = 40;
	g_bmp.width = (int)g_width;
	g_bmp.height = (int)g_height * -1;
	g_bmp.planes = 1;
	g_bmp.bpp = 32;
	g_bmp.compression = 0;
	g_bmp.imagesize = (int)g_width * (int)g_height * 4;
